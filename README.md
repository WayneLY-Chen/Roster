...
最新版本 **v1.15.0** — 這一版改了什麼見 [`CHANGELOG.md`](CHANGELOG.md)
...
| **聯絡人** | 跨公司搜尋所有具名聯絡人 |
| **爬取** | 執行爬取、選擇要收集哪些欄位、貼網址建立自訂來源、補抓信箱、補公司登記資料、補齊公司資料、重新驗證 |
...
| 文件 | 內容 |
|---|---|
| [爬取一個網站](docs/爬取.md) | 讓程式去找名錄、用精靈建立來源、PDF 名冊、要按按鈕才出現的資料、只有查詢框的名錄、抓到的東西不對怎麼修、補抓信箱、補公司登記資料、只有公司名稱時怎麼補齊 |
